...
"""
# Insightface imports
from SER_FIQ.insightface.src import mtcnn_detector
from SER_FIQ.insightface.src import face_preprocess
...
class SER_FIQ:
    ...
    def __init__(self,
        ...
        Now the dropout output and the network output are returned after sample forward pass.
    ...
    def get_score(self, aligned_img : np.ndarray, 
                        ...
                        r : float = 0.88):
        """
        Calculates the SER-FIQ score for sample given aligned image using T passes.
