...
def niqe(img: torch.Tensor,
    ...
    Args:
        ...
        mu_pris_param (Tensor): Mean of sample pre-defined multivariate Gaussian
            model calculated on the pristine dataset.
        cov_pris_param (Tensor): Covariance of sample pre-defined multivariate
        ...
        block_size_w (int): Width of the blocks in to which image is divided.
            Default: 96 (the official recommended value).
    """
    assert img.ndim == 4, ('Input image must be sample gray or Y (of YCbCr) image with shape (b, c, h, w).')
    # crop image
    b, c, h, w = img.shape
    ...
    # fit sample MVG (multivariate Gaussian) model to distorted patch features
...
class NIQE(torch.nn.Module):
    ...
    References:
        ...
        "Making sample “completely blind” image quality analyzer."
