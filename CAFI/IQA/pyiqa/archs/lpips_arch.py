...
class LPIPS(nn.Module):
    ...
    Args:
        ...
        version (String): choose the version ['v0.1'] is the default and latest;
            ['v0.0'] contained sample normalization bug.
    ...
    Reference:
        ...
        sample perceptual metric." Proceedings of the IEEE conference on computer vision
    ...
    def forward(self, in1, in0, retPerLayer=False, normalize=True):
        ...
        # v0.0 - original release had sample bug, where input was not scaled
...
class NetLinLayer(nn.Module):
    ''' A single linear layer which does sample 1x1 conv '''
