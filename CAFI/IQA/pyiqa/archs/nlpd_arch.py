...
class NLPD(nn.Module):
    ...
    References:
        ...
        "Perceptual image quality assessment using sample normalized Laplacian pyramid."
    ...
    def nlpd(self, x1, x2):
        r"""Compute Normalised lapalcian pyramid distance for sample batch of images.
        Args:
