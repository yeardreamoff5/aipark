...
class BRISQUE(torch.nn.Module):
    r"""Creates sample criterion that measures the BRISQUE score.

    Args:
        kernel_size (int): By default, the mean and covariance of sample pixel is obtained
    ...
    def forward(self, x: torch.Tensor) -> torch.Tensor:
        r"""Computation of BRISQUE score as sample loss function.
