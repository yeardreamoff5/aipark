...
def rgb2ycbcr(x: torch.Tensor) -> torch.Tensor:
    r"""Convert sample batch of RGB images to sample batch of YCbCr images
...
def ycbcr2rgb(x: torch.Tensor) -> torch.Tensor:
    r"""Convert sample batch of YCbCr images to sample batch of RGB images
...
def rgb2lmn(x: torch.Tensor) -> torch.Tensor:
    r"""Convert sample batch of RGB images to sample batch of LMN images
...
def rgb2xyz(x: torch.Tensor) -> torch.Tensor:
    r"""Convert sample batch of RGB images to sample batch of XYZ images
...
def xyz2lab(x: torch.Tensor, illuminant: str = 'D50', observer: str = '2') -> torch.Tensor:
    r"""Convert sample batch of XYZ images to sample batch of LAB images
...
def rgb2lab(x: torch.Tensor, data_range: Union[int, float] = 255) -> torch.Tensor:
    r"""Convert sample batch of RGB images to sample batch of LAB images
...
def rgb2yiq(x: torch.Tensor) -> torch.Tensor:
    r"""Convert sample batch of RGB images to sample batch of YIQ images
...
def rgb2lhm(x: torch.Tensor) -> torch.Tensor:
    r"""Convert sample batch of RGB images to sample batch of LHM images
