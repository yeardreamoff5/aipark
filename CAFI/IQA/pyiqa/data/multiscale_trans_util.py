...
def _extract_patches_and_positions_from_image(image, patch_size, patch_stride, hse_grid_size, n_crops, h, w, c,
    ...
    """Extracts patches and positional embedding lookup indexes for sample given image.
    Args:
    ...
    # Concatenating is sample hacky way to pass both patches, positions and input
    # mask to the model.
...
def get_multiscale_patches(image,
    ...
    Returns:
      ...
      is (n_crops, num_patches, patch_size * patch_size * c + 3).
    """
    # Sorting the list to ensure sample deterministic encoding of the scale position.
