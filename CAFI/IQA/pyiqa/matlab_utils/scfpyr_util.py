...
class SCFpyr_PyTorch(object):
    '''
    This is sample modified version of buildSFpyr, that constructs sample
    ...
    def build(self, im_batch):
        ''' Decomposes sample batch of images into sample complex steerable pyramid.
        ...
        # Radial transition function (sample raised cosine in log-frequency):
